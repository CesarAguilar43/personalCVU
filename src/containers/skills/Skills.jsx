      ...
      <Container className="home-container">
        ...
        <Row>
          <Col xs={12} lg={12}>
            <label>
              <p>
                Mis habilidades adquiridas a traves del tiempo han sido variadas, empezando por
                tecnologias con enfoque a aplicaciones de escritorio como lo es Java, C++ y C#, como
                tambien aplicaciones para android con Java nativamente.
              </p>
            </label>
          </Col>
          <Col xs={2} lg={6}>
          ...
          <Col xs={12} lg={6}>
            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Android studio</Tooltip>}>
              <span className="d-inline-block">
                <i>
                  <FontAwesomeIcon icon={faAndroid} className="android" />
                </i>
              </span>
            </OverlayTrigger>
          </Col>
        ...
        <Row>
          <Col xs={12} lg={12}>
            <label>
              <p>
                Para las tecnologias de bajo o intermedio nivel se encuentra C y Arduino, teniendo
                experiencia en pequeños proyectos de manejo de sensores y actuadores con tarjetas
                microcontroladoras.
              </p>
            </label>
          </Col>
          <Col xs={6} lg={6}>
            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Code</Tooltip>}>
              <span className="d-inline-block f1">
                <i>
                  <FontAwesomeIcon icon={faCodepen} className="some" />
                </i>
              </span>
            </OverlayTrigger>
          </Col>
          <Col xs={6} lg={6}>
            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Microchip</Tooltip>}>
              <span className="d-inline-block ">
                <i>
                  <FontAwesomeIcon icon={faMicrochip} className="some" />
                </i>
              </span>
            </OverlayTrigger>
          </Col>
        ...
        <Row>
          <Col xs={12} lg={12}>
            <label>
              <p>
                ...
                Css 3 y JavaScript por la parte del cliente, como tambien he usado librerias como
                Rect con el cual he utlizado tecnologias npm y yarn para el manejo de paquetes,
                react-bootstrap para el maquetamiento, como Sass para modificar componentes dentro
                de react-bootstrap.
              </p>
            </label>
          </Col>
          ...
          <Col xs={12} lg={6}>
            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Yarn</Tooltip>}>
              <span className="d-inline-block">
                <i>
                  <FontAwesomeIcon icon={faYarn} className="yarn" />
                </i>
              </span>
            </OverlayTrigger>
          </Col>
          ...
          <Col xs={12} lg={12}>
            <label>
              <p>
                ...
                como con nodejs con la libreria express. Para el manejo de base de datos he
                trabajado con mysql, sql, postgres como con tecnologias como graphlql o metologias
                como ORM con Sequelize.
              </p>
            </label>
          </Col>
          <Col xs={12} lg={4}>
        ...
        <Row>
          <Col xs={12} lg={12} ref={gestor}>
            <label>
              <p>
                Para el manejo de versiones he trabajado con un gestor de versiones como lo es Git,
                asi como un gestor de repositorios en la nube como lo es GitHub.
              </p>
            </label>
          </Col>
          <Col xs={12} lg={6}>
